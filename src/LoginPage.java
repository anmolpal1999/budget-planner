...
public class LoginPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon("E:\\Java\\Documents\\Media\\app-icon.png")); // NOI18N
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon("E:\\Java\\Documents\\Media\\user-login-icon-14.png")); // NOI18N
...
//           PreparedStatement st=con.prepareStatement("select * from adminlogin where adminid=? and adminpwd=?");
//           st.setString(1,id);
//           st.setString(2,pass);
//           
...
java.sql.PreparedStatement st=con.prepareStatement("select * from adminlogin where adminid=? and adminpwd=?");
st.setString(1,id);
st.setString(2,pass);
ResultSet rs= st.executeQuery();
if(rs.next())
